 ...
 * @author ckm
 * @date 2019年6月3日 下午5:21:22
 */
public class TokenUtils {

	private static Map<String, String> MAP_TOKENS = new HashMap<String, String>();
	private static int VALID_TIME = 60 * 60 * 24 * 3; // token有效期(秒)
	...
	/**
	 * 生成token,该token长度不一致,如需一致,可自行MD5或者其它方式加密一下 该方式的token只存在磁盘上,如果项目是分布式,最好用redis存储
	 * 
	...
	public static void main(String[] args) {
		String str = "e1ac4a1c014d4413ba22d890a4a4e485";
