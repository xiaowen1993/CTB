package com.ctb.accesstoken.constants;
...
public class AccesstokenConstants {
    public static Logger logger = LoggerFactory.getLogger(AccesstokenConstants.class);
     ...
     * 微信公众号JSTicket缓存前缀
     */
    public static final String CACHE_WECHAT_JSTICKET_KEY_PREFIX = "wechat.JSTicket.hash";
