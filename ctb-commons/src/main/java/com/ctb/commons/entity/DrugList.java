...
public class DrugList implements Serializable {
	...
	private static final long serialVersionUID = -9002845847367211829L;
...
//	  
//	public void setHospitalCode(String hospitalCode) { this.hospitalCode =
//	  hospitalCode; }
	 
	public DrugList(String id, String drugName, String drugCode, String cadn, String approvalNo, String manufacturer,
			String specification, String usage) {
