...
public class PaySettings implements Serializable{
    
    /**
     *
     */
    	
    private static final long serialVersionUID = 944753443077019219L;
	...
	public PaySettings(String appId, String appSecret, String mchId, String payKey, String certificatePath) {
		super();
		this.appId = appId;
	...
	public PaySettings(String id, String appId, String appSecret, String mchId, String payKey, String certificatePath) {
		super();
		this.id = id;
		this.appId = appId;
		this.appSecret = appSecret;
