...
public class DataPayMzFee implements Serializable{
    
    /**
     *
     */
    	
    private static final long serialVersionUID = 3082974952232779971L;
	...
	public List<DataPayMzFeeDetail> getDataPayMzFeeDetails() {
		return dataPayMzFeeDetails;
	}

	public void setDataPayMzFeeDetails(List<DataPayMzFeeDetail> dataPayMzFeeDetails) {
	...
	public DataPayMzFee(String mzFeeId) {
		super();
    ...
    public DataPayMzFee(String id, String hospitalId, String hospitalCode, String hospitalName, String branchId,
			String branchCode, String branchName, Long storageTime, String patientName, Integer cardType, String cardNo,
			String mzFeeId, String clinicTime, String deptName, String doctorName, String payType, String payAmout,
			String medicareAmout, String totalAmout, String ssClinicNo, String ssBillNumber, String canUseInsurance,
			String recipeType, String recipeId, String mzBillId, String insuranceAmout) {
		super();
		this.id = id;
	...
	public DataPayMzFee(Map<String, Object> UserInfoMap) {
	    String cardType = (String) UserInfoMap.get("cardType");
	    this.branchId = (String) UserInfoMap.get("branchId");
	    this.cardNo = (String) UserInfoMap.get("cardNo");
	    this.cardType = cardType!=null ? Integer.parseInt(cardType) : 0;
	    this.hospitalCode = (String) UserInfoMap.get("hospitalCode");
	    this.hospitalId = (String) UserInfoMap.get("hospitalId");
	    this.patientName = (String) UserInfoMap.get("name");
	    this.branchCode = (String) UserInfoMap.get("branchCode");
	    this.openId = (String) UserInfoMap.get("openId");
	}
	
    public DataPayMzFee(DataPayMzFee dataPayMzFee, Map<String, Object> MZDataMap) {
        
        this.id = dataPayMzFee.getId();
        this.openId = dataPayMzFee.getOpenId();
        this.branchId = dataPayMzFee.getBranchId();
        this.cardNo = dataPayMzFee.getCardNo();
        this.cardType = dataPayMzFee.getCardType();
        this.hospitalCode = dataPayMzFee.getHospitalCode();
        this.hospitalId = dataPayMzFee.getHospitalId();
        this.patientName = dataPayMzFee.getPatientName();
        this.branchCode = dataPayMzFee.getBranchCode();
        
        this.branchName = (String) MZDataMap.get("branchHospitalName");
        this.canUseInsurance = (String) MZDataMap.get("canUseInsurance");
        this.deptName = (String) MZDataMap.get("deptName");
        this.clinicTime = (String) MZDataMap.get("clinicTime");
        this.doctorName = (String) MZDataMap.get("doctorName");
        this.payAmout = (String) MZDataMap.get("payAmout");
        this.mzFeeId = (String) MZDataMap.get("mzFeeId");
        this.hospitalName = (String) MZDataMap.get("hospitalName");
        this.insuranceAmout = (String) MZDataMap.get("insuranceAmout");
        this.medicareAmout = (String) MZDataMap.get("medicareAmout");
        this.mzBillId = (String) MZDataMap.get("mzBillId");
        this.payType = (String) MZDataMap.get("payType");
        this.recipeType = (String) MZDataMap.get("recipeType");
        this.ssClinicNo = (String) MZDataMap.get("sSClinicNo");
        this.totalAmout = (String) MZDataMap.get("totalAmout");
        this.ssBillNumber = (String) MZDataMap.get("sSBillNumber");
        this.recipeId = (String) MZDataMap.get("recipeId");
        String storageTime = (String) MZDataMap.get("storageTime");
        this.storageTime = storageTime != null ? Long.parseLong(storageTime) : 0L;        
    }
