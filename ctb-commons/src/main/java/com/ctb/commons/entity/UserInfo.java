...
public class UserInfo implements Serializable{
    ...
    private static final long serialVersionUID = 5424728066709339561L;
	...
	public UserInfo(String id, String refUnionId, String hisOpenId, String name, Integer sex, Integer age, String birth,
			String mobile, Integer idType, String idNo, String address, Integer cardType, String cardNo,
			String guardName, Integer guardIdType, String guardIdNo, String guardMobile, String hospitalId,
			String hospitalCode, String hospitalName, String branchId, String branchCode, String branchName,
			String platformMode) {
		super();
		this.id = id;
		this.refUnionId = refUnionId;
		this.hisOpenId = hisOpenId;
		this.name = name;
		this.sex = sex;
		this.age = age;
		this.birth = birth;
