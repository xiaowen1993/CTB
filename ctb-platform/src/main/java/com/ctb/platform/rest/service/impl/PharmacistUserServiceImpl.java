...
/**
 * @ClassName: com.ctb.platform.rest.service.impl.PharmacistServiceImpl
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author hhy
 * @date 2019年7月2日 下午4:57:32
 */
@Service
public class PharmacistUserServiceImpl implements PharmacistUserService{
    ...
    public PharmacistUser queryPharmacist(PharmacistUser pharmacist) {
        ...
        try {
            ...
            if (StringUtils.isNotBlank(pharmacist.getName())) {
                criteria.andLike("name", "%" + pharmacist.getName() + "%");
            }
