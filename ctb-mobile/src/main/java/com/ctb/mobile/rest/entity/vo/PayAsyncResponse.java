...
/**
 * 
 * @ClassName: com.ctb.mobile.rest.entity.vo.PayAsynResponse
 * @Description: TODO(支付异步回调)
 * @author cwq
 * @date 2019年4月28日 下午8:30:41
 */
public class PayAsyncResponse implements Serializable {
	...
	public PayAsyncResponse() {
		super();
	}

	public PayAsyncResponse(String resultCode, String resultMsg) {
		super();
		this.resultCode = resultCode;
		this.resultMsg = resultMsg;
	}
